...
- **Установите новейшие обновления**
  ...
  - Подпишитесь на рассылку новостей о програмном обеспечении, которое часто используете. Например, [Apple security-announce](https://lists.apple.com/mailman/listinfo/security-announce).
