...
- **Установите новейшие обновления**
  ...
  - Подпишитесь на рассылку новостей програмного обеспечения, которое часто используете. Например, [Apple security-announce](https://lists.apple.com/mailman/listinfo/security-announce).
